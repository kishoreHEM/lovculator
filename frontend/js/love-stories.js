...
// 1. Add this to your existing DOMContentLoaded listener
document.addEventListener("DOMContentLoaded", () => {
    // ... existing setup ...
    
    // Check if we are on a permalink (e.g., /post/123)
...
// 2. Function to fetch and show the modal
async function openPostModal(postId) {
    try {
        ...
        // Use your existing card creator!
        const postCard = createPostCard(post);
        postCard.style.cssText = "max-width: 600px; width: 100%; max-height: 90vh; overflow-y: auto; margin: 0;";
        ...
        closeBtn.style.cssText = `
            ...
            background: none; border: none; font-size: 30px; color: white; cursor: pointer;
        `;
        ...
        const closeModal = () => {
            ...
            // Optional: Update URL back to feed without refreshing
        ...
        if(window.showNotification) showNotification("Post not found or deleted", "error");
    }
}
